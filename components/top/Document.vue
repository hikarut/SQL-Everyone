  ...
  <div class="bg-gray-100">
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
      ...
      <div class="aspect-w-16 aspect-h-7">
        ...
        >
          <img
            class="w-full md:w-1/2 lg:w-1/2 object-cover rounded-xl block mx-auto"
            :src="documentImage"
            alt="Features Image"
          />
        </a>
